...
export const SUPPORTED_INSTANCE_TYPES = new Set(['array', 'boolean', 'integer', 'null', 'number', 'object', 'string']);
...
function assertSchemaKeywordValues(rule, location) {
  ...
  if (Object.hasOwn(rule, 'minItems') && Object.hasOwn(rule, 'maxItems') && rule.maxItems < rule.minItems) {
  ...
  if (Object.hasOwn(rule, 'minimum') && Object.hasOwn(rule, 'maximum') && rule.maximum < rule.minimum) {
